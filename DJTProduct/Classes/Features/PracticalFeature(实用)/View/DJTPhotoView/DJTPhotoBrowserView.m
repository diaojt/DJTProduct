...
@interface DJTPhotoBrowserView()<UICollectionViewDelegate, UICollectionViewDataSource, DJTPhotoBrowserCollectionViewCellDelegate>
...
@implementation DJTPhotoBrowserView
- (instancetype)init
{
    self = [super init];
    if (self) {
...
{
    DJTPhotoBrowserCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
...
- (void)setListModel:(DJTPhotoListModel *)listModel
{
...
- (UICollectionView *)collectionView
{
    if (_collectionView == nil) {
        ...
        [_collectionView registerClass:[DJTPhotoBrowserCollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
